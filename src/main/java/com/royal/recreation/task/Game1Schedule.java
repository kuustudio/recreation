 ...
 */
@Component
public class Game1Schedule implements InitializingBean {
    ...
    @Autowired
    public Game1Schedule(SpringApplicationContext context, KjService kjService) {
    ...
    private boolean action12List(LocalDateTime actionTime) {
        ...
        String url = "https://cqssc.17500.cn/tools/getwinlist.html?limit=5";
        ...
        try {
            ...
            logger.warn("数据:{}", result);
            successFlag = false;
            logger.info("action1出现异常", e);
        } finally {
