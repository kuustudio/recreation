...
var LHC_KJTZ = {
    ...
    SHUANMA_PLAYIDS_D: [7092002, 7092004, 7092006, 7092008, 7092010, 7092012, 7092014, 7092016, 7092019, 7092020, 7092022, 7092024, 7092026, 7092028, 7092030, 7092032, 7092034, 7092036, 7092038, 7092040, 7092042, 7092044, 7092046, 7092048],
    ...
    XIAOSHUAN_PLAYIDS_D: [7092002, 7092004, 7092006, 7092008, 7092010, 7092012, 7092014, 7092016, 7092019, 7092020, 7092022, 7092024],
    ...
    HEDAN_PLAYIDS_D: [7092001, 7092003, 7092005, 7092007, 7092009, 7092010, 7092012, 7092014, 7092016, 7092019, 7092021, 7092023, 7092025, 7092027, 7092029, 7092030, 7092032, 7092034, 7092036, 7092038, 7092041, 7092043, 7092045, 7092047, 7092049],
    ...
    XIAOMA_PLAYIDS_D: [7092001, 7092002, 7092003, 7092004, 7092005, 7092006, 7092007, 7092008, 7092009, 7092010, 7092011, 7092012, 7092013, 7092014, 7092015, 7092016, 7092017, 7092019, 7092019, 7092020, 7092021, 7092022, 7092023, 7092024],
    ...
    HEDA_PLAYIDS_D: [7092007, 7092008, 7092009, 7092016, 7092017, 7092019, 7092019, 7092025, 7092026, 7092027, 7092028, 7092029, 7092033, 7092034, 7092035, 7092036, 7092037, 7092038, 7092039, 7092043, 7092044, 7092045, 7092046, 7092047, 7092048, 7092049],
    ...
    YITOU_PLAYIDS_D: [7092010, 7092011, 7092012, 7092013, 7092014, 7092015, 7092016, 7092017, 7092019, 7092019],
    ...
    BAWEI_PLAYIDS_D: [7092008, 7092019, 7092028, 7092038, 7092048],
    ...
    SHENXIAO_6_D: [7092006, 7092019, 7092030, 7092042],
    ...
    HONG_D: [7092001, 7092002, 7092007, 7092008, 7092012, 7092013, 7092019, 7092019, 7092023, 7092024, 7092029, 7092030, 7092034, 7092035, 7092040, 7092045, 7092046],
    ...
    HONE_SHUAN_D: [7092002, 7092008, 7092012, 7092019, 7092024, 7092030, 7092034, 7092040, 7092046],
    ...
    HONE_XIAO_D: [7092001, 7092002, 7092007, 7092008, 7092012, 7092013, 7092019, 7092019, 7092023, 7092024],
    ...
    QUANGXUAN_D: [7092001, 7092002, 7092003, 7092004, 7092005, 7092006, 7092007, 7092008, 7092009, 7092010, 7092011, 7092012, 7092013, 7092014, 7092015, 7092016, 7092017, 7092019, 7092019, 7092020, 7092021, 7092022, 7092023, 7092024, 7092025, 7092026, 7092027, 7092028, 7092029, 7092030, 7092031, 7092032, 7092033, 7092034, 7092035, 7092036, 7092037, 7092038, 7092039, 7092040, 7092041, 7092042, 7092043, 7092044, 7092045, 7092046, 7092047, 7092048, 7092049],
...
var UserBet = {
    ...
    openBetWindow: function () {
        ...
        var j = '			<tr style="height: 30px;">				<td style="text-align: left;padding-left:5px;" class="multiple">{playCateName} {alias} {playName} {betNums} {otherStr} </td>				<td><span class=" c-txt4">{playOdds}</span></td>				<td><input type="text" style="width: 85%" value="{betMoney}" id="win_bet_text_{checkboxId}" nums="{nums}" checkbox_id="{checkboxId}" play_id="{playId}" bet_info="{betNums}" playids="{playIds}"/></td>				<td ><input type="checkbox" checked="checked" id="win_bet_checkbox_{checkboxId}" checkbox_id="{checkboxId}"></td>			</tr>';
        var b = 0;
        var p = "";
        var c = 0;
...
var PullMsg = {
    ...
    formatUserBetNew: function (e) {
        if (e && e.length > 0) {
            var c = "";
            var o = '	        		<li>		        		<p>期号：<span class="bid">{turnNum}</span></p>				        <p>内容：<span class="text">{playCateName} {alias} {playName} {multiple} {betInfo}</span>@ <span class="odds">{odds}</span></p>				        <p>积分：￥{money}</p>				    </li>	        		';
    ...
    formatWinMsg: function (b) {
        if (b && b.length > 0) {
            ...
            var c = "";
            var a = '<li>{gameName} 第 {turnNum} 期 {playCateName} {alias} {playName} 已中奖 {winCount} {winBill},中奖积分 <span style="color:#e04f4c">{rewardRebate}</span></li>';
            $(b).each(function (g, n) {
                            ...
                            if (UserBet.gameId == 61) {
                                ...
                                if (UserBet.gameId == 70 || UserBet.gameId == 74) {
                                    ...
                                    if (UserBet.gameId == 66) {
                                        var f = 0;
                                        for (var e = 0; e < g.length; e++) {
                                            a += '<span class="ball mr15 c-g2 ">' + g[e] + "</span>";
                                            f += parseInt(g[e])
                                        }
                                        a += '<span style="margin:5px;5px;0px;0px; color:#000">总和：</span>';
                                        a += '<span class="ball mr15 c-g2 ">' + f + "</span>"
                                    } else {
                                        for (var e = 0; e < g.length; e++) {
                                            a += '<span class="ball mr15 c-g2 ">' + g[e] + "</span>"
                                        }
