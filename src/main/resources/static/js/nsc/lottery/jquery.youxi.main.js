    ...
    $.gameInit = function(opts){//整个购彩界面的初始化
        var ps = {//整个JS的初试化默认参数
            ...
            data_id : {
                        ...
                        id_sel_money    : '#lt_sel_money',//装载选号区投注积分的ID
                        ...
                        id_cf_money     : '#lt_cf_money',//装载确认区总投注积分的ID
        ...
        $($.lt_id_data.id_cf_clear).click(function(){//清空按钮
            $.confirm(lot_lang.am_s5,function(){
                ...
                $.lt_total_money = 0;//总积分清零
                $.lt_trace_base  = 0;//追号积分基数清零
