$(function(){
	...
	// setInterval(function(){
	// 	parent.reloadMemberInfo();
	// 	$.getJSON('/Tip/getZNX', function(tip){
	// 		if(tip){
	// 			if(!tip.flag) return;
	// 			var buttons=[];
	...
	// 							,shade: 0
	// 							,'offset': 'rb'
	// 							,content: '<div style="padding:10px;font-size:18px;margin-top:21px;text-align:center;color:#555;"><a href="/Boxs/receive/"  target="_blank">'+ tip.message +'</a></div>'
	// 							,zIndex: parent.layer.zIndex //重点1
	// 							,success: function(layero){
	// 								parent.layer.setTop(layero); //重点2
	// 							}
