;(function($){//start
    ...
    $.fn.lt_trace = function(){
		...
		*/
        ...
        function upTraceCount(){//更新追号总期数和总积分
        ...
        //根据利润率计算当期需要的倍数[起始倍数，利润率，单倍购买积分，历史购买积分，单倍奖金],返回倍数
        ...
        $($.lt_id_data.id_tra_ok).click(function(){
            ...
            var msg='';//提示信息
            if( t_type == 'same' ){
                var m = $.lt_trace_base*times;//每期积分
                tm = m*ic;//总积分=每期积分*期数
                for( var i=0; i<ic; i++ ){
