...
$(function(){
	...
	(function(){
		...
		if(cvis === "true"){
			...
			$hide.addClass("hide");
			$hide.attr("title","显示积分");
		}else{
			$refresh.css("display","inline-block");
			$hide.attr("title","隐藏积分");
			$showMoney.show();
			$hideMoney.hide();
		}
...
$(document).ready(function(){
    var bgCssConfig = {"cssName" : "bgCss" , "cssNameTemp" : "nsc_background02"};
    var clientObj = {
    	"isclient" : null,
    ...
    function initBgCss(){//初始化背景cookie
      ...
      //  if(_localdata === "" || _localdata === null){
            clientObj.setItem("bgCss","nsc_background07");
            bgCssConfig["cssName"] = "nsc_background07";
            $("body").removeClass().addClass("nsc_background07");
        //}else{
